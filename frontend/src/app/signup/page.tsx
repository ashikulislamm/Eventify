            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-start gap-3 pt-2">
                <input
                  ...
                  className="w-5 h-5 text-primary border-gray-300 rounded focus:ring-primary focus:ring-2 mt-0.5 cursor-pointer"
                />
              ...
              <button
                type="submit"
                disabled={isLoading || success}
                className="w-full bg-gradient-to-r from-primary to-accent text-white py-4 rounded-xl font-bold hover:shadow-lg hover:shadow-primary/30 transition-all transform hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none flex items-center justify-center gap-2"
              >
                {isLoading ? (
                  <>
